-- =============================================
-- TUMBUHIDE.ID V3 DATABASE SCHEMA - CLEAN VERSION
-- =============================================
...
DROP TYPE IF EXISTS analytics_event CASCADE;
...
-- =============================================
-- PROFILES TABLE (Enhanced with email column)
-- =============================================
CREATE TABLE profiles (
  id UUID REFERENCES auth.users(id) ON DELETE CASCADE PRIMARY KEY,
  email TEXT NOT NULL, -- PENTING: Kolom email harus ada
...
CREATE INDEX idx_social_links_status ON social_links(status);
CREATE INDEX idx_social_links_order ON social_links(user_id, display_order);

CREATE INDEX idx_custom_links_user_id ON custom_links(user_id);
CREATE INDEX idx_custom_links_status ON custom_links(status);
CREATE INDEX idx_custom_links_order ON custom_links(user_id, display_order);

CREATE INDEX idx_showcase_user_id ON showcase_items(user_id);
CREATE INDEX idx_showcase_order ON showcase_items(user_id, display_order);

CREATE INDEX idx_analytics_user_id ON analytics(user_id);
CREATE INDEX idx_analytics_event_type ON analytics(event_type);
CREATE INDEX idx_analytics_created_at ON analytics(created_at);
CREATE INDEX idx_analytics_user_date ON analytics(user_id, created_at);
