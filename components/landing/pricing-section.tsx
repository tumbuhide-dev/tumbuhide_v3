      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Mulai gratis dan upgrade dengan kode undangan. Semua paket include hosting, SSL, dan support dari tim kami.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600 dark:text-gray-400">
            Semua paket include hosting unlimited, SSL certificate, dan backup otomatis.
            <br />
            <span className="font-medium">Tidak ada biaya tersembunyi.</span>
          </p>
          <div className="mt-4">
